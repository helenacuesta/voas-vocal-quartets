...
def optimize_threshold_individual(validation_files, patch_len, model, exp_name):
    ...
    for song in validation_files:
        ...
        best_thresh_sop.append(thresh_vals[np.argmax(avg_thresh_sop)])
        best_thresh_alt.append(thresh_vals[np.argmax(avg_thresh_alt)])
        best_thresh_ten.append(thresh_vals[np.argmax(avg_thresh_ten)])
    ...
    best_thresh_bass = np.mean(best_thresh_bass)
